...
from app.database.schemas.track_winner import TrackWinnerSchema
from . import base
...
class TrackWinner(base.BaseModel):
    ...
    t_track_team_id = Column(Integer, ForeignKey("track_team.id", ondelete="CASCADE"), nullable=False)
